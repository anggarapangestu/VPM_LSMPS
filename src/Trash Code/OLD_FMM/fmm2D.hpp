...
private:
    ...
    std::vector<std::vector<std::complex<double>>> ak;  // Multipole expansion, origin at current cell center
    std::vector<std::vector<std::complex<double>>> bk;  // Local expansion, origin at current cell center
